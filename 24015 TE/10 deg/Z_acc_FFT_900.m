...
title('Acceleration vs Time - NACA 24015 at 10 \circ AOA','FontSize',16,'FontWeight','normal')
% ylim([0.5 2])
figure(2)
...
ylim([0 20])
legend ('Trailing Edge','FontSize',12,'FontWeight','normal')
title('Acceleration vs Frequency - NACA 24015 at 10 \circ AOA','FontSize',16,'FontWeight','normal')