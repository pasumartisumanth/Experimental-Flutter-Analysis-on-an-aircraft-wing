...
title('Acceleration vs Time - NACA 31015 at 0 \circ AOA','FontSize',16,'FontWeight','normal')
ylim([0.5 2])
figure(2)
...
ylim([0 20])
legend ('Leading Edge','Trailing Edge','FontSize',12,'FontWeight','normal')
title('Acceleration vs Frequency - NACA 31015 at 0 \circ AOA','FontSize',16,'FontWeight','normal')